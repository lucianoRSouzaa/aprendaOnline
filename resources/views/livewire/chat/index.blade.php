<div class="row">
    <section class="col-4 conversas barra">
        <div class="pesquisar d-flex align-items-center justify-content-between">
            ...
            <div class="adicionar d-flex justify-content-center">
    ...
    <section class="col-8 choose-conversation">

        <div class="d-flex h-100 align-items-center justify-content-center gap-3">

            <h4 class="text-center">Escolha alguma conversa</h4>
